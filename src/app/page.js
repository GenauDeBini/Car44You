...
export default function Home() {
  ...
  return (
    <>
      <SixtHeader />
      <div
        className="w-full relative min-h-screen bg-gradient-to-b from-black via-gray-900 to-orange-600 flex flex-col items-center justify-center overflow-hidden"
        style={{ width: "100%" }}
      >
        <div className="w-full max-w-5xl mx-auto px-4">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-6 md:p-8 w-full z-10 mt-40">
