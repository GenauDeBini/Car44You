...
export default function LoginForm() {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center bg-gray-900 text-white p-6 overscroll-none"
      style={{ overscrollBehavior: "none" }}
    >
      <SixtHeader />
      <form
        onSubmit={handleSubmit}
        className="bg-gray-800 p-8 rounded-2xl shadow-xl w-full max-w-sm mt-24"
      >
